...
@register_command(
    "vm extension publish update",
)
class Update(AAZCommand):
    """Update a Shared VM Extension.
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SharedVmExtensionsGet(ctx=self.ctx)()
    ...
    class SharedVmExtensionsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _build_schema_shared_vm_extension_read(cls._schema_on_200)
    ...
    class SharedVmExtensionsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _build_schema_shared_vm_extension_read(cls._schema_on_200_201)
...
_schema_shared_vm_extension_read = None


def _build_schema_shared_vm_extension_read(_schema):
    global _schema_shared_vm_extension_read
    if _schema_shared_vm_extension_read is not None:
        _schema.id = _schema_shared_vm_extension_read.id
        _schema.location = _schema_shared_vm_extension_read.location
        _schema.name = _schema_shared_vm_extension_read.name
        _schema.properties = _schema_shared_vm_extension_read.properties
        _schema.tags = _schema_shared_vm_extension_read.tags
        _schema.type = _schema_shared_vm_extension_read.type
        return

    _schema_shared_vm_extension_read = AAZObjectType()

    shared_vm_extension_read = _schema_shared_vm_extension_read
    shared_vm_extension_read.id = AAZStrType(
        flags={"read_only": True},
    )
    shared_vm_extension_read.location = AAZStrType(
        flags={"required": True},
    )
    shared_vm_extension_read.name = AAZStrType(
        flags={"read_only": True},
    )
    shared_vm_extension_read.properties = AAZObjectType(
        flags={"client_flatten": True},
    )
    shared_vm_extension_read.tags = AAZDictType()
    shared_vm_extension_read.type = AAZStrType(
        flags={"read_only": True},
    )

    properties = _schema_shared_vm_extension_read.properties
    ...
    identifier = _schema_shared_vm_extension_read.properties.identifier
    ...
    tags = _schema_shared_vm_extension_read.tags
