...
@register_command(
    "vm extension publish-version create",
)
class Create(AAZCommand):
    """Create a shared VM Extension Version.
    """
    ...
    class SharedVmExtensionVersionsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            certificate = cls._schema_on_200_201.properties.certificate
            ...
            input_endpoints = cls._schema_on_200_201.properties.endpoints.input_endpoints
            input_endpoints.Element = AAZObjectType()

            _element = cls._schema_on_200_201.properties.endpoints.input_endpoints.Element
            ...
            instance_input_endpoints = cls._schema_on_200_201.properties.endpoints.instance_input_endpoints
            instance_input_endpoints.Element = AAZObjectType()

            _element = cls._schema_on_200_201.properties.endpoints.instance_input_endpoints.Element
            ...
            internal_endpoints = cls._schema_on_200_201.properties.endpoints.internal_endpoints
            internal_endpoints.Element = AAZObjectType()

            _element = cls._schema_on_200_201.properties.endpoints.internal_endpoints.Element
            _element.name = AAZStrType()
            _element.port = AAZIntType()
            _element.protocol = AAZStrType()

            local_resources = cls._schema_on_200_201.properties.local_resources
            local_resources.Element = AAZObjectType()

            _element = cls._schema_on_200_201.properties.local_resources.Element
            _element.name = AAZStrType()
            _element.size_in_mb = AAZIntType(
                serialized_name="sizeInMB",
            )

            regions = cls._schema_on_200_201.properties.regions
